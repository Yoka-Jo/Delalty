...
class _AppServiceClient implements AppServiceClient {
  ...
  Future<HttpResponse<MessageResponse>> createMessage(
    ...
    _data.files.addAll(files.map((i) => MapEntry('attachments', i)));
    final _result = await _dio.fetch<Map<String, dynamic>>(
  ...
  Future<HttpResponse<List<MessageResponse>>> getMessages(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<MessageResponse>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<HttpResponse<List<ProductResponse>>> getTrendingProducts() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
