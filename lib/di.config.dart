...
import 'package:delalty/core/app_prefs/shared_prefs_injectable.dart' as _i59;
import 'package:delalty/core/network/dio_factory.dart' as _i58;
...
import 'package:delalty/domain/usecases/get_trending_products_usecase.dart'
    as _i36;
import 'package:delalty/domain/usecases/get_user_data_usecase.dart' as _i37;
import 'package:delalty/domain/usecases/google_login_usecase.dart' as _i38;
import 'package:delalty/domain/usecases/login_usecase.dart' as _i40;
import 'package:delalty/domain/usecases/register_usecase.dart' as _i43;
...
import 'package:delalty/presentation/screens/all_departments/cubit/all_departments_cubit.dart'
    as _i4;
import 'package:delalty/presentation/screens/app/cubit/app_cubit.dart' as _i51;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i36.GetTrendingProductsUseCase>(
        () => _i36.GetTrendingProductsUseCase(gh<_i13.Repository>()));
    gh.lazySingleton<_i37.GetUserDataUseCase>(
        () => _i37.GetUserDataUseCase(gh<_i13.Repository>()));
    gh.lazySingleton<_i38.GoogleLoginUseCase>(
        () => _i38.GoogleLoginUseCase(gh<_i13.Repository>()));
    gh.factory<_i39.HomeCubit>(() => _i39.HomeCubit(
          ...
          gh<_i36.GetTrendingProductsUseCase>(),
        ));
    gh.lazySingleton<_i40.LoginUseCase>(
        () => _i40.LoginUseCase(gh<_i13.Repository>()));
    gh.factory<_i41.ProductCubit>(() => _i41.ProductCubit(
          gh<_i33.GetProductUseCase>(),
          gh<_i30.GetProductCommentsUseCase>(),
        ));
    gh.factory<_i42.ProhibitedPersonsCubit>(() =>
        _i42.ProhibitedPersonsCubit(gh<_i20.ChangeRelationshipTypeUseCase>()));
    gh.lazySingleton<_i43.RegisterUseCase>(
        () => _i43.RegisterUseCase(gh<_i13.Repository>()));
    gh.lazySingleton<_i44.RemoveProductFromFavoritesUseCase>(
        () => _i44.RemoveProductFromFavoritesUseCase(gh<_i13.Repository>()));
    gh.lazySingleton<_i45.RemoveRelationshipUseCase>(
        () => _i45.RemoveRelationshipUseCase(gh<_i13.Repository>()));
    gh.factory<_i46.SearchCubit>(() => _i46.SearchCubit(
          gh<_i15.SearchForProductsUseCase>(),
          gh<_i18.AddProductToRecentlySearchedUseCase>(),
          gh<_i34.GetRecentlySearchedProductsUseCase>(),
          gh<_i27.GetCategoryUseCase>(),
        ));
    gh.factory<_i47.SellerProfileCubit>(() => _i47.SellerProfileCubit(
          gh<_i37.GetUserDataUseCase>(),
          gh<_i35.GetSellerProductsUseCase>(),
          gh<_i20.ChangeRelationshipTypeUseCase>(),
        ));
    gh.factory<_i48.SignupCubit>(
        () => _i48.SignupCubit(gh<_i43.RegisterUseCase>()));
    gh.factory<_i49.VerificationCodeCubit>(
        () => _i49.VerificationCodeCubit(gh<_i16.VerifyPhoneUseCase>()));
    gh.factory<_i50.ViewProductSectionCubit>(() =>
        _i50.ViewProductSectionCubit(gh<_i31.GetProductForCategoryUseCase>()));
    gh.factory<_i51.AppCubit>(
        () => _i51.AppCubit(gh<_i37.GetUserDataUseCase>()));
    gh.factory<_i52.ConversationCubit>(() => _i52.ConversationCubit(
          gh<_i22.CreateMessageUseCase>(),
          gh<_i29.GetMessagesUseCase>(),
        ));
    gh.factory<_i53.CreateChatCubit>(
        () => _i53.CreateChatCubit(gh<_i21.CreateChatUseCase>()));
    gh.factory<_i54.FavoriteCubit>(() => _i54.FavoriteCubit(
          gh<_i28.GetFavoritesUseCase>(),
          gh<_i17.AddProductToFavoritesUseCase>(),
          gh<_i44.RemoveProductFromFavoritesUseCase>(),
        ));
    gh.factory<_i55.LoginCubit>(() => _i55.LoginCubit(gh<_i40.LoginUseCase>()));
    gh.factory<_i56.RelationshipCubit>(() => _i56.RelationshipCubit(
          gh<_i20.ChangeRelationshipTypeUseCase>(),
          gh<_i45.RemoveRelationshipUseCase>(),
        ));
    return this;
  }
}
...
class _$InjectableAppServiceClientModule
    extends _i57.InjectableAppServiceClientModule {}

class _$InjectableDioModule extends _i58.InjectableDioModule {}

class _$InjectableUserSecureStorageModule
    extends _i10.InjectableUserSecureStorageModule {}

class _$SharedPrefsInjectableModule extends _i59.SharedPrefsInjectableModule {}
