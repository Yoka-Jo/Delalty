...
import 'package:delalty/data/datasources/remote_datasource/remote_modules.dart'
    as _i16;
import 'package:delalty/data/network/dio_factory.dart' as _i17;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i12.UserSecureStorage>(
        () => _i12.UserSecureStorage(gh<_i5.FlutterSecureStorage>()));
    gh.factory<_i13.VerificationCodeCubit>(() => _i13.VerificationCodeCubit());
    gh.factory<_i14.LocalDataSource>(
        () => _i14.LocalDataSource(gh<_i10.SharedPreferences>()));
    gh.lazySingleton<_i15.LoginUseCase>(
        () => _i15.LoginUseCase(gh<_i7.Repository>()));
    return this;
  }
}

class _$InjectableAppServiceClientModule
    extends _i16.InjectableAppServiceClientModule {}

class _$InjectableDioModule extends _i17.InjectableDioModule {}

class _$InjectableUserSecureStorageModule
    extends _i12.InjectableUserSecureStorageModule {}

class _$SharedPrefsInjectableModule extends _i18.SharedPrefsInjectableModule {}
