...
import 'package:delalty/domain/usecases/get_recently_searched_products_usecase.dart'
    as _i29;
import 'package:delalty/domain/usecases/get_user_data_usecase.dart' as _i30;
import 'package:delalty/domain/usecases/google_login_usecase.dart' as _i31;
import 'package:delalty/domain/usecases/login_usecase.dart' as _i33;
import 'package:delalty/domain/usecases/register_usecase.dart' as _i35;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i30.GetUserDataUseCase>(
        () => _i30.GetUserDataUseCase(gh<_i12.Repository>()));
    gh.lazySingleton<_i31.GoogleLoginUseCase>(
        () => _i31.GoogleLoginUseCase(gh<_i12.Repository>()));
    ...
    gh.lazySingleton<_i33.LoginUseCase>(
        () => _i33.LoginUseCase(gh<_i12.Repository>()));
    gh.factory<_i34.ProductCubit>(() => _i34.ProductCubit(
          gh<_i28.GetProductUseCase>(),
          gh<_i25.GetProductCommentsUseCase>(),
        ));
    gh.lazySingleton<_i35.RegisterUseCase>(
        () => _i35.RegisterUseCase(gh<_i12.Repository>()));
    gh.lazySingleton<_i36.RemoveProductFromFavoritesUseCase>(
        () => _i36.RemoveProductFromFavoritesUseCase(gh<_i12.Repository>()));
    gh.factory<_i37.SearchCubit>(() => _i37.SearchCubit(
