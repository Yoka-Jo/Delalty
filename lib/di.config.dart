...
import 'package:delalty/core/app_prefs/shared_prefs_injectable.dart' as _i58;
import 'package:delalty/core/network/dio_factory.dart' as _i57;
...
import 'package:delalty/presentation/screens/all_departments/cubit/all_departments_cubit.dart'
    as _i4;
import 'package:delalty/presentation/screens/app/cubit/app_cubit.dart' as _i50;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i44.RemoveRelationshipUseCase>(
        () => _i44.RemoveRelationshipUseCase(gh<_i13.Repository>()));
    ...
    gh.factory<_i46.SellerProfileCubit>(() => _i46.SellerProfileCubit(
    ...
    gh.factory<_i47.SignupCubit>(
        () => _i47.SignupCubit(gh<_i42.RegisterUseCase>()));
    gh.factory<_i48.VerificationCodeCubit>(
        () => _i48.VerificationCodeCubit(gh<_i16.VerifyPhoneUseCase>()));
    gh.factory<_i49.ViewProductSectionCubit>(() =>
        _i49.ViewProductSectionCubit(gh<_i31.GetProductForCategoryUseCase>()));
    gh.factory<_i50.AppCubit>(
        () => _i50.AppCubit(gh<_i36.GetUserDataUseCase>()));
    gh.factory<_i51.ConversationCubit>(() => _i51.ConversationCubit(
          gh<_i22.CreateMessageUseCase>(),
          gh<_i29.GetMessagesUseCase>(),
        ));
    gh.factory<_i52.CreateChatCubit>(
        () => _i52.CreateChatCubit(gh<_i21.CreateChatUseCase>()));
    gh.factory<_i53.FavoriteCubit>(() => _i53.FavoriteCubit(
          gh<_i28.GetFavoritesUseCase>(),
          gh<_i17.AddProductToFavoritesUseCase>(),
          gh<_i43.RemoveProductFromFavoritesUseCase>(),
        ));
    gh.factory<_i54.LoginCubit>(() => _i54.LoginCubit(gh<_i39.LoginUseCase>()));
    gh.factory<_i55.RelationshipCubit>(() => _i55.RelationshipCubit(
          gh<_i20.ChangeRelationshipTypeUseCase>(),
          gh<_i44.RemoveRelationshipUseCase>(),
        ));
    return this;
  }
}
...
class _$InjectableAppServiceClientModule
    extends _i56.InjectableAppServiceClientModule {}

class _$InjectableDioModule extends _i57.InjectableDioModule {}

class _$InjectableUserSecureStorageModule
    extends _i10.InjectableUserSecureStorageModule {}

class _$SharedPrefsInjectableModule extends _i58.SharedPrefsInjectableModule {}
